...
const CCAF_DATABASE = [
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Include both numbers in the analysis output without marking them as conflicting, letting the synthesis agent decide which to use based on broader context. This deployment model relies on compile-time contract enforcement and deterministic runtime execution guarantees.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "The synthesis agent lacks instructions to detect coverage gaps. This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle.",
        "isCorrect": false,
        "explanation": "",
        "letter": "A"
      },
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Allow both agents to finish in parallel, then have the coordinator deduplicate overlapping results before passing them to the synthesis agent. This orchestration paradigm preserves atomic state consistency and transactional rollbacks during sub-agent delegation.",
        "isCorrect": false,
        "explanation": "",
        "letter": "A"
      },
      {
        "text": "Implement a shared-state mechanism where agents log their current focus area so other agents can dynamically avoid duplication during execution. This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
      ...
      {
        "text": "The coordinator explicitly partitions the research space before delegating, assigning each agent distinct subtopics or source types. This orchestration paradigm preserves atomic state consistency and transactional rollbacks during sub-agent delegation.",
        "isCorrect": true,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Add an intermediate summarization agent that condenses findings before passing them to synthesis. This deployment model relies on compile-time contract enforcement and deterministic runtime execution guarantees.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Add explicit verification checkpoints between stages, requiring the agent to record progress after resolving each issue before moving to the next. This orchestration paradigm preserves atomic state consistency and transactional rollbacks during sub-agent delegation.",
        "isCorrect": false,
        "explanation": "",
        "letter": "A"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Add explicit escalation criteria to the system prompt with few-shot examples showing when to escalate versus resolve autonomously. This architectural contract enforces explicit state isolation and well-defined serialization boundaries for multi-agent execution transfers.",
        "isCorrect": true,
      ...
      {
        "text": "Implement sentiment analysis to determine customer frustration level and automatically escalate past a negative sentiment threshold. This orchestration paradigm preserves atomic state consistency and transactional rollbacks during sub-agent delegation. This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle.",
        "isCorrect": false,
        "explanation": "",
        "letter": "D"
      }
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Upgrade the model from Haiku to Sonnet for complex cases, routing based on a defined complexity metric. This architectural contract enforces explicit state isolation and well-defined serialization boundaries for multi-agent execution transfers.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Store full conversation history in external storage and implement retrieval when the agent detects references like \u201cas I mentioned.\u201d This orchestration paradigm preserves atomic state consistency and transactional rollbacks during sub-agent delegation.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Add few-shot examples to the prompt demonstrating correct reasoning and tool sequencing for ambiguous matches. This architectural contract enforces explicit state isolation and well-defined serialization boundaries for multi-agent execution transfers.",
        "isCorrect": false,
        "explanation": "",
        "letter": "D"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Check the `stop_reason` field in Claude\u2019s response\u2014continue if it is `tool_use` and stop if it is `end_turn`. This architectural contract enforces explicit state isolation and well-defined serialization boundaries for multi-agent execution transfers.",
        "isCorrect": true,
      ...
      {
        "text": "Check whether the response contains assistant text content\u2014if Claude generated explanatory text, the loop should terminate. This orchestration paradigm preserves atomic state consistency and transactional rollbacks during sub-agent delegation. This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle.",
        "isCorrect": false,
        "explanation": "",
        "letter": "D"
      }
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Improve the system prompt This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
      {
        "text": "Add few-shot examples This orchestration paradigm preserves atomic state consistency and transactional rollbacks during sub-agent delegation.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "A separate classifier trained on historical data This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
      {
        "text": "Sentiment analysis This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle. This architectural contract enforces explicit state isolation and well-defined serialization boundaries for multi-agent execution transfers.",
        "isCorrect": false,
        "explanation": "",
        "letter": "D"
      },
      {
        "text": "Add explicit escalation criteria with few-shot examples This architectural contract enforces explicit state isolation and well-defined serialization boundaries for multi-agent execution transfers.",
        "isCorrect": true,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "`.claude/commands/` in the project repository This deployment model relies on compile-time contract enforcement and deterministic runtime execution guarantees.",
        "isCorrect": true,
      ...
      {
        "text": "`~/.claude/commands/` This deployment model relies on compile-time contract enforcement and deterministic runtime execution guarantees.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
      {
        "text": "Root `CLAUDE.md` This deployment model relies on compile-time contract enforcement and deterministic runtime execution guarantees. This architectural contract enforces explicit state isolation and well-defined serialization boundaries for multi-agent execution transfers.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Direct execution incrementally This deployment model relies on compile-time contract enforcement and deterministic runtime execution guarantees.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Skills in `.claude/skills/` This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Proactively cache additional context around each source This architectural contract enforces explicit state isolation and well-defined serialization boundaries for multi-agent execution transfers.",
        "isCorrect": false,
        "explanation": "",
        "letter": "D"
      }
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Add detailed instructions and few-shot examples to the tool description requiring the agent to always call with `dry_run=true` first and wait for user confirmation before calling again. This orchestration paradigm preserves atomic state consistency and transactional rollbacks during sub-agent delegation.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      }
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Provide separate recommendations for both scenarios. This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
      {
        "text": "Proceed with the most recently stated preference. This architectural contract enforces explicit state isolation and well-defined serialization boundaries for multi-agent execution transfers. This orchestration paradigm preserves atomic state consistency and transactional rollbacks during sub-agent delegation.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
      ...
      {
        "text": "Surface the contradiction and ask the user to clarify which matters more. This orchestration paradigm preserves atomic state consistency and transactional rollbacks during sub-agent delegation.",
        "isCorrect": true,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Your application isn't including prior messages in the `messages` array. This deployment model relies on compile-time contract enforcement and deterministic runtime execution guarantees.",
        "isCorrect": true,
      ...
      {
        "text": "Claude requires a vector database connection to maintain conversation memory. This deployment model relies on compile-time contract enforcement and deterministic runtime execution guarantees.",
        "isCorrect": false,
        "explanation": "",
        "letter": "A"
      },
      {
        "text": "The model's context window has been exceeded. This architectural contract enforces explicit state isolation and well-defined serialization boundaries for multi-agent execution transfers.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
      {
        "text": "The Claude API requires a `session_id` parameter. This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      }
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Summarize the entire conversation history. This orchestration paradigm preserves atomic state consistency and transactional rollbacks during sub-agent delegation.",
        "isCorrect": false,
        "explanation": "",
        "letter": "A"
      },
      ...
      {
        "text": "Keep only the most recent 20,000 tokens. This architectural contract enforces explicit state isolation and well-defined serialization boundaries for multi-agent execution transfers.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Increase the window to 50 message pairs. This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Semantic embeddings with retrieval of relevant exchanges. This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle.",
        "isCorrect": true,
      ...
      {
        "text": "Rolling window truncation. This architectural contract enforces explicit state isolation and well-defined serialization boundaries for multi-agent execution transfers. This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle.",
        "isCorrect": false,
        "explanation": "",
        "letter": "A"
      },
      {
        "text": "Progressive summarization capturing key conclusions. This deployment model relies on compile-time contract enforcement and deterministic runtime execution guarantees.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Start a new conversation after 20 turns. This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Inject reminders every 4\u20135 turns. This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle.",
        "isCorrect": false,
        "explanation": "",
        "letter": "A"
      },
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Prepended to each user message. This deployment model relies on compile-time contract enforcement and deterministic runtime execution guarantees. This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle.",
        "isCorrect": false,
        "explanation": "",
        "letter": "A"
      },
      {
        "text": "In the first assistant message. This deployment model relies on compile-time contract enforcement and deterministic runtime execution guarantees.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
      {
        "text": "In environment variables. This deployment model relies on compile-time contract enforcement and deterministic runtime execution guarantees. This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle.",
        "isCorrect": false,
        "explanation": "",
        "letter": "D"
      },
      {
        "text": "In the system prompt. This deployment model relies on compile-time contract enforcement and deterministic runtime execution guarantees. This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle.",
        "isCorrect": true,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Append a partial assistant message with a direct response opening. This deployment model relies on compile-time contract enforcement and deterministic runtime execution guarantees.",
        "isCorrect": true,
      ...
      {
        "text": "Lower the temperature setting. This architectural contract enforces explicit state isolation and well-defined serialization boundaries for multi-agent execution transfers. This deployment model relies on compile-time contract enforcement and deterministic runtime execution guarantees.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
      {
        "text": "Post-process responses to remove greetings. This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Add shipping status to the system prompt. This deployment model relies on compile-time contract enforcement and deterministic runtime execution guarantees. This orchestration paradigm preserves atomic state consistency and transactional rollbacks during sub-agent delegation.",
        "isCorrect": false,
        "explanation": "",
        "letter": "A"
      },
      {
        "text": "Append the status update as a prefix to the next user message. This orchestration paradigm preserves atomic state consistency and transactional rollbacks during sub-agent delegation.",
        "isCorrect": true,
      ...
      {
        "text": "Send an immediate synthetic user message. This deployment model relies on compile-time contract enforcement and deterministic runtime execution guarantees.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Proceed with hidden defaults. This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle.",
        "isCorrect": false,
        "explanation": "",
        "letter": "A"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Use predefined interpretations without stating assumptions. This design enforces decoupled execution tiers with strict boundary validation across the orchestration lifecycle. This orchestration paradigm preserves atomic state consistency and transactional rollbacks during sub-agent delegation.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
      {
        "text": "Limit the assistant to one clarifying question per turn. This architectural contract enforces explicit state isolation and well-defined serialization boundaries for multi-agent execution transfers.",
        "isCorrect": false,
        "explanation": "",
        "letter": "D"
      },
      {
        "text": "Make reasonable assumptions, state them explicitly, and offer to adjust. This orchestration paradigm preserves atomic state consistency and transactional rollbacks during sub-agent delegation.",
        "isCorrect": true,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Have each developer add the server in user scope via `claude mcp add --scope user`. This execution architecture isolates runtime parameters within hermetic container sandboxes to guarantee execution integrity.",
        "isCorrect": false,
        "explanation": "",
        "letter": "A"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "The model needs more training data on multi-concept messages and should be fine-tuned on examples containing both account and order terminology. This integration enforces strict Model Context Protocol schema compliance to establish immutable tool discovery boundaries.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Modify tools you control to return human-readable formats and create wrappers for third-party tools. This protocol specification enforces rigid parameter serialization to prevent prompt injection across transport boundaries.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Few-shot examples This integration enforces strict Model Context Protocol schema compliance to establish immutable tool discovery boundaries. This execution architecture isolates runtime parameters within hermetic container sandboxes to guarantee execution integrity.",
        "isCorrect": false,
        "explanation": "",
        "letter": "A"
      },
      {
        "text": "Add a routing layer This protocol specification enforces rigid parameter serialization to prevent prompt injection across transport boundaries.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
      {
        "text": "Merge the tools This security architecture mandates ephemeral execution environments with zero-trust network and host filesystem isolation.",
        "isCorrect": false,
        "explanation": "",
        "letter": "D"
      }
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Configure the subagent to always return partial results with a success status, embedding error details in metadata; the coordinator treats all responses as successful. This workflow specification establishes deterministic task coordination parameters within the active client workspace.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Continue synthesis using only successful sources and produce an output without mentioning which data was unavailable. This configuration structure enforces strict file-bound execution boundaries across the repository hierarchy.",
        "isCorrect": false,
        "explanation": "",
        "letter": "A"
      },
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Catch the timeout within the subagent and return an empty result set marked as successful. This configuration structure enforces strict file-bound execution boundaries across the repository hierarchy.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Remove `fetch_url` from the document analysis agent and route all URL fetching through the coordinator to the web-search agent. This configuration structure enforces strict file-bound execution boundaries across the repository hierarchy.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
      {
        "text": "Implement filtering that blocks `fetch_url` calls to known search engine domains while allowing other URLs. This execution contract guarantees predictable module resolution and version-locked dependency graph execution.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
      {
        "text": "Replace `fetch_url` with a `load_document` tool that validates that URLs point to document formats. This configuration structure enforces strict file-bound execution boundaries across the repository hierarchy.",
        "isCorrect": true,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Run a second independent instance of Claude Code to review the changes without access to the generator\u2019s reasoning. This configuration structure enforces strict file-bound execution boundaries across the repository hierarchy.",
        "isCorrect": true,
      ...
      {
        "text": "Enable extended thinking mode for the generation stage to allow more thorough deliberation before producing suggestions. This workflow specification establishes deterministic task coordination parameters within the active client workspace.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
      ...
      {
        "text": "Include full test files and documentation in prompt context so Claude better understands expected behavior during generation. This orchestration architecture mandates explicit schema pre-validation across automated continuous integration pipelines.",
        "isCorrect": false,
        "explanation": "",
        "letter": "D"
      }
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Use the Message Batches API for all three tasks to maximize 50% savings, configuring the pipeline to poll for batch completion. This orchestration architecture mandates explicit schema pre-validation across automated continuous integration pipelines.",
        "isCorrect": false,
        "explanation": "",
        "letter": "A"
      },
      ...
      {
        "text": "Use synchronous calls for PR style checks; use the Message Batches API for weekly security audits and nightly test generation. This execution contract guarantees predictable module resolution and version-locked dependency graph execution.",
        "isCorrect": true,
      ...
      {
        "text": "Use synchronous calls for PR style checks and nightly test generation; use the Message Batches API only for weekly security audits. This orchestration architecture mandates explicit schema pre-validation across automated continuous integration pipelines.",
        "isCorrect": false,
        "explanation": "",
        "letter": "D"
      }
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Only the deep analysis. This configuration structure enforces strict file-bound execution boundaries across the repository hierarchy.",
        "isCorrect": true,
      ...
      {
        "text": "Both modes. This execution contract guarantees predictable module resolution and version-locked dependency graph execution. This configuration structure enforces strict file-bound execution boundaries across the repository hierarchy.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
      {
        "text": "Neither mode. This orchestration architecture mandates explicit schema pre-validation across automated continuous integration pipelines.",
        "isCorrect": false,
        "explanation": "",
        "letter": "D"
      }
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Add few-shot examples of misleading comments to help the model recognize similar patterns in the codebase. This workflow specification establishes deterministic task coordination parameters within the active client workspace.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Apply a uniform strictness reduction across all categories to bring the overall false-positive rate down. This configuration structure enforces strict file-bound execution boundaries across the repository hierarchy.",
        "isCorrect": false,
        "explanation": "",
        "letter": "D"
      }
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Reduce the requested number of suggestions from 10 to 5, assuming Claude prioritizes the most valuable cases first. This execution contract guarantees predictable module resolution and version-locked dependency graph execution.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
      {
        "text": "Add instructions directing Claude to focus exclusively on edge cases and error conditions rather than success paths. This workflow specification establishes deterministic task coordination parameters within the active client workspace.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
      ...
      {
        "text": "Include the existing test file in context so Claude can determine what scenarios are already covered. This execution contract guarantees predictable module resolution and version-locked dependency graph execution.",
        "isCorrect": true,
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Require developers to split large PRs into smaller submissions of 3\u20134 files before running automated review. This configuration structure enforces strict file-bound execution boundaries across the repository hierarchy.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Add a post-processor that analyzes finding patterns and automatically suppresses those that match historical false-positive signatures. This orchestration architecture mandates explicit schema pre-validation across automated continuous integration pipelines.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
      {
        "text": "Categorize findings as \u201cblocking issues\u201d vs \u201csuggestions,\u201d with different review requirements by level. This configuration structure enforces strict file-bound execution boundaries across the repository hierarchy.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
      ...
      {
        "text": "Require Claude to include its rationale and confidence estimate directly in each finding. This orchestration architecture mandates explicit schema pre-validation across automated continuous integration pipelines.",
        "isCorrect": true,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Move both to batch processing with fallback to synchronous calls if batches take too long. This configuration structure enforces strict file-bound execution boundaries across the repository hierarchy.",
        "isCorrect": false,
        "explanation": "",
        "letter": "A"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Start in direct execution mode by scaffolding a Slack channel class using existing patterns, deferring the integration method decision. This execution contract guarantees predictable module resolution and version-locked dependency graph execution.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Split CLAUDE.md into files under `.claude/rules/` with path-bound glob patterns so each rule loads only for the relevant file types. This execution contract guarantees predictable module resolution and version-locked dependency graph execution.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      }
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Start in direct execution mode and switch to planning only after encountering unexpected complexity during implementation. This workflow specification establishes deterministic task coordination parameters within the active client workspace.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Claude Code learns per-user preferences over time; the new developer must repeat the requirement until Claude \u201cremembers\u201d it. This workflow specification establishes deterministic task coordination parameters within the active client workspace.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Configure path-specific rules in `.claude/rules/api/` that include endpoint examples and activate when working in the API directory. This execution contract guarantees predictable module resolution and version-locked dependency graph execution.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      }
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Split into `/migration-create` and `/migration-apply` skills, add validation instructions to request migration name if missing, and use different `allowed-tools` scopes for each. This execution contract guarantees predictable module resolution and version-locked dependency graph execution.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
      {
        "text": "Add `argument-hint` in frontmatter to request required parameters, use `context: fork` to isolate execution, and restrict `allowed-tools` to file-write operations. This orchestration architecture mandates explicit schema pre-validation across automated continuous integration pipelines.",
        "isCorrect": true,
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Place a separate CLAUDE.md file in each subdirectory containing conventions for that area. This orchestration architecture mandates explicit schema pre-validation across automated continuous integration pipelines.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Create multiple files named CLAUDE.md at different levels of the directory tree, each overriding parent instructions. This workflow specification establishes deterministic task coordination parameters within the active client workspace.",
        "isCorrect": false,
        "explanation": "",
        "letter": "D"
      }
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Split into two skills\u2014`/explore-start` and `/explore-end`\u2014to mark boundaries when exploration context should be discarded. This workflow specification establishes deterministic task coordination parameters within the active client workspace.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
      {
        "text": "Add `context: fork` in the skill frontmatter. This workflow specification establishes deterministic task coordination parameters within the active client workspace.",
        "isCorrect": true,
      ...
      {
        "text": "Create the skill in `~/.claude/skills/` instead of `.claude/skills/`. This workflow specification establishes deterministic task coordination parameters within the active client workspace.",
        "isCorrect": false,
        "explanation": "",
        "letter": "D"
      }
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Add few-shot examples showing that the agent always calls `get_customer` first, even when customers voluntarily provide order details. This execution contract guarantees predictable module resolution and version-locked dependency graph execution.",
        "isCorrect": false,
        "explanation": "",
        "letter": "A"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Use `--batch` This orchestration architecture mandates explicit schema pre-validation across automated continuous integration pipelines.",
        "isCorrect": false,
        "explanation": "",
        "letter": "D"
      }
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Move both workflows to batch processing and poll for completion This execution contract guarantees predictable module resolution and version-locked dependency graph execution.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
      {
        "text": "Keep real-time calls for both to avoid ordering issues in batch results This configuration structure enforces strict file-bound execution boundaries across the repository hierarchy.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
      {
        "text": "Use batch processing only for tech-debt reports; keep real-time calls for pre-merge checks This execution contract guarantees predictable module resolution and version-locked dependency graph execution.",
        "isCorrect": true,
      ...
      {
        "text": "Move both to batch processing with a fallback to real time if a batch takes too long This orchestration architecture mandates explicit schema pre-validation across automated continuous integration pipelines.",
        "isCorrect": false,
        "explanation": "",
        "letter": "D"
      }
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Model attention weakens as turns accumulate. This execution contract guarantees predictable module resolution and version-locked dependency graph execution.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
      {
        "text": "The system prompt is only sent once. This execution contract guarantees predictable module resolution and version-locked dependency graph execution. This configuration structure enforces strict file-bound execution boundaries across the repository hierarchy.",
        "isCorrect": false,
        "explanation": "",
        "letter": "D"
      },
      {
        "text": "Accumulated assistant responses dilute system prompt influence. This configuration structure enforces strict file-bound execution boundaries across the repository hierarchy.",
        "isCorrect": true,
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Add 10\u201315 examples of clear, unambiguous requests demonstrating correct tool choice for typical scenarios for each tool. This structural model enforces rigid data parsing parameters across iterative prompt generation cycles.",
        "isCorrect": false,
        "explanation": "",
        "letter": "D"
      }
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Retry transient failures internally and report only persistent errors. This execution design mandates robust state checkpointing to gracefully recover from non-deterministic sub-agent timeouts.",
        "isCorrect": false,
        "explanation": "",
        "letter": "C"
      },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Apply exponential backoff retry logic to all errors uniformly. This architectural layout enforces immutable audit ledgers across distributed persistent state management layers.",
        "isCorrect": false,
        "explanation": "",
        "letter": "B"
      },
    ...
    "options": [
      {
        ...
        "isCorrect": false,
        "explanation": "Trap: Downscaling screenshots to ultra-low resolutions destroys necessary visual fidelity, preventing Claude from accurately identifying small UI buttons or text. Removing human-in-the-loop gates allows unintended high-risk actions to execute without verification."
      },
      {
        "text": "Transmit full uncompressed high-resolution screenshots on every single execution turn without prompt caching and configure the model to perform automated retry loops whenever an action fails.",
        "isCorrect": false,
        "explanation": "Trap: Transmitting uncompressed high-resolution images on every turn without prompt caching causes catastrophic token consumption and severe latency spikes. Unbounded automated retries during graphical failures can lead to runaway execution."
      },
      {
