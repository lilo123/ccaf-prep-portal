...
const CCAF_DATABASE = [
  {
    ...
    "options": [
      ...
      {
        "text": "Increase the context window size of all specialized sub-agents to 200k tokens, ensuring they retain the complete multi-turn history of every prior code migration attempt.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Enable high temperature (0.9) and instruct the agent to write highly condensed, single-line code representations, exceeding overall system execution budget allocations.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Increase the client-side HTTP request deadline timeout to 300 seconds forcing immediate blocking execution operations.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Configure the agent to run in raw plan-only mode without state memory, ignoring structural parameter requirements within schema options.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Instruct the agent in the prompt to try executing the auth command again with a different password, exceeding overall system execution budget allocations.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Run the analysis using a lower temperature (0.0) to speed up model responses, forcing immediate blocking execution operations.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Use session storage to cache files before writing to the filesystem, exceeding overall system execution budget allocations.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Wrap the entire pipeline in a single try-catch block that retries the cleaning step up to 20 times, forcing immediate blocking execution operations.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Widen the orchestrator's context window so it can see all sub-agent execution environments in real time, removing structured tool constraints entirely from prompt headers.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Disable the email deletion tool entirely for the agent, circumventing protocol connection validation checks, ignoring structural parameter requirements within schema options.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Set the temperature to 0.0 to make prompt generation more deterministic, forcing immediate blocking execution operations.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Store database credentials directly in in-memory cache, circumventing protocol connection validation checks.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Instruct the model in the system prompt to compute and output its latency numbers exceeding overall system execution budget allocations.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Widen the testing timeout to 10 minutes to give the agent time to self-correct, removing structured tool constraints entirely from prompt headers.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Rely on the browser's native caching mechanism to speed up downloads, forcing immediate blocking execution operations.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Create separate git branches for each folder, keeping folder-specific CLAUDE.md files on separate branch heads, to prevent pipeline failures.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Link Claude Code to a local MCP server running a distilled Llama model, configuring the local CLAUDE.md file instructions to run in offline-only mode inside the sandboxed container environment, to prevent pipeline failures.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Run Claude Code with the `--fast` flag ensuring deterministic execution constraints.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Use a Chrome browser window to monitor the agent's sessions, as this conforms strictly to corporate security compliance requirements and local AST validation hooks, utilizing project-level skills configured via slash commands to intercept git commits automatically.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Widen the root.gitignore to include the neighboring project folders ensuring deterministic execution constraints.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Store these rules in the static local configuration files file, to prevent pipeline failures.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Widen the pipeline execution timeout to 30 minutes, configuring the local CLAUDE.md file instructions to run in offline-only mode inside the sandboxed container environment, to prevent pipeline failures.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Instruct the compiler to write all object files to a remote server ensuring deterministic execution constraints.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Store formatting rules in in-memory cache ensuring deterministic execution constraints.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Run Claude Code inside a Chrome browser tab, as this conforms strictly to corporate security compliance requirements and local AST validation hooks, utilizing project-level skills configured via slash commands to intercept git commits automatically.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Disable all bash tools inside the container ensuring deterministic execution constraints.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Store the commands inside the static local configuration files file, to prevent pipeline failures.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Instruct each developer to manually type the coverage flags in their terminals, which automatically inherits parent directory constraints and simplifies multi-folder configuration management, to prevent pipeline failures.",
        "isCorrect": false,
        "explanation": "Trap: Manual instructions do not automate the agent's test runner pipeline, leading to incomplete test execution."
      },
      {
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Configure the downstream parser to execute a try-catch loop that attempts to eval() the raw text, preventing markdown backtick noise.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Increase the model temperature to 1.0 to allow the model to evaluate synonyms creatively, utilizing strict XML tag encapsulation structures directly inside the user prompt instructions to guide parsing scripts, preventing markdown backtick noise.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Spread the retrieved snippets randomly throughout the entire prompt chain, using strict XML schema checks, to bypass token prefill limits.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Disable the system prompt entirely to prevent injection attacks, as this enforces deterministic model outputs and prevents unhandled conversational syntax exceptions, which minimizes prefill tokens and maximizes Prompt Caching prefix hits on concurrent API calls.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Increase the model temperature to 1.0 to allow the model to infer missing details creatively, using strict XML schema checks, to bypass token prefill limits.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Configure the downstream parser to execute a try-catch loop that attempts to eval() the raw text, which minimizes prefill tokens and maximizes Prompt Caching prefix hits on concurrent API calls.",
        "isCorrect": false,
        "explanation": "Trap: Running eval() on uncleaned LLM text is a severe security vulnerability and fails frequently on conversational preambles."
      },
      {
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Write a system prompt telling the agent to always be highly structured, using strict XML schema checks, preventing markdown backtick noise.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Widen the context window of the model to maximum capacity, which minimizes prefill tokens and maximizes Prompt Caching prefix hits on concurrent API calls, preventing markdown backtick noise.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Set the temperature to 0.0 to make prompt generation more deterministic, preventing markdown backtick noise.",
        "isCorrect": false,
        "explanation": "Trap: Temperature controls model output generation, not prompt input caching prefix logic."
      },
      {
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Write a system prompt telling the agent to always follow XML guidelines strictly, utilizing strict XML tag encapsulation structures directly inside the user prompt instructions to guide parsing scripts.",
        "isCorrect": false,
        "explanation": "Trap: LLMs are highly prone to silent style violations without an explicit validation check gate."
      },
      {
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Manually edit the brackets in the local script instead of calling the API again, using strict XML schema checks, to bypass token prefill limits.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Implement an interval cron validation check on the server, relying on post-processing code extraction utility hooks to strip out raw backtick blocks dynamically, which minimizes prefill tokens and maximizes Prompt Caching prefix hits on concurrent API calls.",
        "isCorrect": false,
        "explanation": "Trap: Post-execution cron checks only detect errors *after* they have already been passed, exposing downstream systems to crashes."
      },
      {
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Place dynamic customer queries at the beginning of the prompt, and append the static system rules at the very end of the message chain, utilizing prompt caching for massive static reference tables.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Instruct the model in the prompt to be extremely careful and double-check that your output is a valid JSON array before sending it.",
        "isCorrect": false,
        "explanation": "Trap: Conversational warnings carry weak success guarantees compared to structured few-shot syntax blocks."
      },
      {
        "text": "Wrap the JSON schema in explicit XML tags and provide clear few-shot examples of valid outputs.",
        "isCorrect": true,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "The tool is running inside a sandboxed container without root permissions exceeding maximum prefill token window limits.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Widen the context window of the Claude client to 200,000 tokens, executing sequential tool decomposition without classification circumventing protocol connection validation checks.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Implement an interval cron validation check on the server, enforcing strict read-only database access permissions and restricting API tool parameters at the engine layer circumventing protocol connection validation checks.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Write a system prompt telling the agent to always follow XML guidelines strictly circumventing protocol connection validation checks.",
        "isCorrect": false,
        "explanation": "Trap: LLMs are highly prone to silent style violations without an explicit validation check gate."
      },
      {
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Widen the Node.js process memory allocation limit to 4GB, enforcing strict read-only database access permissions and restricting API tool parameters at the engine layer circumventing protocol connection validation checks.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Set the model temperature to 1.0 during retries, utilizing prompt caching for massive static reference tables kept exclusively at the beginning of the message chain embedding raw database tables directly into static system instructions.",
        "isCorrect": false,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Set the reasoning temperature of all agents to 0.0, which leverages prefix matching logic to achieve high prompt caching hits and reduce API cost overhead embedding raw database tables directly into static system instructions.",
        "isCorrect": false,
        "explanation": "Trap: Determinism does not guarantee formatting compliance without a validation rule."
      },
      {
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "text": "Implement a dedicated approval interceptor within the tool execution layer that automatically halts routing workflows and enforces cryptographic two-party authentication.",
        "isCorrect": true,
  ...
  },
  {
    ...
    "options": [
      {
        "text": "Implement a rolling summarization gate: summarize historical turns while keeping recent turns intact.",
        "isCorrect": true,
...
const proxyById = new Proxy(rawById, {
  get(target, prop, receiver) {
    if (prop === 'get' || prop === 'has' || prop === 'entries' || prop === 'keys' || prop === 'values' || prop === 'forEach' || prop === 'size') {
